...
window.IF_DATA = {
  ...
  pastTalks: [
    { year: '2024', title: 'Ignite Talk: Sound money meets sound food', speaker: 'Bitcoin Park community', length: '12 min' },
    { year: '2024', title: 'Ignite Talk: A Lightning network in the Smokies', speaker: 'Eastern TN builders', length: '8 min' },
    { year: '2025', title: 'Ignite Talk: Sovereign data is sovereign self', speaker: 'Nostr collective', length: '14 min' },
    { year: '2025', title: 'Ignite Talk: Mining heat, growing tomatoes', speaker: 'Hash Hashemian', length: '10 min' },
    { year: '2025', title: 'Ignite Talk: The teenager who self-custodies', speaker: 'Citadel Dispatch', length: '9 min' },
    { year: '2025', title: 'Ignite Talk: Why charity needs Bitcoin', speaker: 'Scott Harrison', length: '11 min' },
  ],
};
